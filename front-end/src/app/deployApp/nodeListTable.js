...
const NodeListTable = (props) => {
    ...
    const ActivateHandler = (node, index) => {
        ...
        console.log('nodeinterfaceListInterface',node,node.interfaceList.Interface)
        // let interfaceArr = [];
        ...
        let appInstancePayload = {
            ...
            "activate": true,
            "interfaces": node && node.interfaceList && node.interfaceList.Interface ?node.interfaceList.Interface :[],
        }
    ...
    const applicationInstancePostAPICall = async (params) => {
        ...
        try {
            ...
            toast.error("Error in Application Instance Post API Call");
                    ...
                    <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg overflow-y-auto h-[400px]">
                            ...
                            <tbody className=" bg-white">
                                {nodeList && nodeList.length > 0 && nodeList.map((node, index) => (
                                    <tr key={index} className={classNames(selectedItems.includes(node) ? 'bg-blue-50' : "bg-white", "border-b-[1px] hover:bg-blue-50")}>
                                        ...
                                        <td className="whitespace-nowrap px-1 py-2 text-sm justify-center items-center text-center">
                                            <button
                        ...
                        {nodeList && nodeList.length > 0 ? <></>
                            : <div className="w-full  justify-center items-center bg-white">
                                <p className='flex text-base h-[300px] leading-9 justify-center items-center'>
